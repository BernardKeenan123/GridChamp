...
const FALLBACK_DRIVERS = [
  ...
  { id: 2, code: "HAD", name: "Hadjar", team: "Red Bull Racing", colour: "#3671C6" },
  { id: 3, code: "NOR", name: "Norris", team: "McLaren", colour: "#FF8000" },
  { id: 4, code: "PIA", name: "Piastri", team: "McLaren", colour: "#FF8000" },
  { id: 5, code: "LEC", name: "Leclerc", team: "Ferrari", colour: "#E8002D" },
  { id: 6, code: "HAM", name: "Hamilton", team: "Ferrari", colour: "#E8002D" },
  { id: 7, code: "RUS", name: "Russell", team: "Mercedes", colour: "#27F4D2" },
  { id: 8, code: "ANT", name: "Antonelli", team: "Mercedes", colour: "#27F4D2" },
  { id: 9, code: "SAI", name: "Sainz", team: "Williams", colour: "#64C4FF" },
  { id: 10, code: "ALB", name: "Albon", team: "Williams", colour: "#64C4FF" },
  { id: 11, code: "ALO", name: "Alonso", team: "Aston Martin", colour: "#229971" },
  { id: 12, code: "STR", name: "Stroll", team: "Aston Martin", colour: "#229971" },
  { id: 13, code: "OCO", name: "Ocon", team: "Haas", colour: "#B6BABD" },
  { id: 14, code: "BEA", name: "Bearman", team: "Haas", colour: "#B6BABD" },
  { id: 15, code: "GAS", name: "Gasly", team: "Alpine", colour: "#FF87BC" },
  { id: 16, code: "COL", name: "Colapinto", team: "Alpine", colour: "#FF87BC" },
  { id: 17, code: "LAW", name: "Lawson", team: "Racing Bulls", colour: "#6692FF" },
  { id: 18, code: "LIN", name: "Lindblad", team: "Racing Bulls", colour: "#6692FF" },
  { id: 19, code: "HUL", name: "Hulkenberg", team: "Audi", colour: "#C0C0C0" },
  { id: 20, code: "BOR", name: "Bortoleto", team: "Audi", colour: "#C0C0C0" },
  { id: 21, code: "BOT", name: "Bottas", team: "Cadillac", colour: "#CC0000" },
  { id: 22, code: "PER", name: "Perez", team: "Cadillac", colour: "#CC0000" },
];
